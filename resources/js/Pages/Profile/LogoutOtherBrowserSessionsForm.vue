<template>
    <jet-action-section>
        <template #title>
            <h2 class="font-semibold text-xl text-gray-200 leading-tight">Browser Sessions</h2>
        </template>
        ...
        <template #content>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
                ...
                <template #footer>
                    <jet-secondary-button @click.native="confirmingLogout = false">Nevermind</jet-secondary-button>
